...
public class MParmorCore : Apparel, IMParmorInstance
{
    ...
    {
        if (ThingMaker.MakeThing(System.building) is MParmorBuilding mParmorBuilding)
        {
    ...
    public void SelfDestruct()
    {
        ...
        if (ThingMaker.MakeThing(ThingDefOf.XFMParmor_MechanicalArmorCore_Wreckage) is not MParmorSelfDestruct
            mParmorSelfDestruct)
        {
            return;
        }
        ...
        mParmorSelfDestruct.energy = (int)(PowerTracker.Battery / 100f);
