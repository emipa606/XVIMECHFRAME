...
public class Building_IceSpike : Building
{
    ...
    protected override void Tick()
    {
        if (WickPercentage >= 1f)
        {
            ...
            var map = Map;
            Destroy();
            GenExplosion.DoExplosion(position, map, 2.9f, DamageDefOf.MParmor_Bomb_IceSpike, thing, 17, 0.7f, null,
    ...
    public void Active()
    {
        ...
        {
            var thing = list[^1];
            var dinfo = new DamageInfo(RimWorld.DamageDefOf.Stab, 12f, 1.2f, -1f, owner);
