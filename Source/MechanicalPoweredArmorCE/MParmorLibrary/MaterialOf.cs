...
{
    public static readonly Material DriverShield = MaterialPool.MatFrom("XFMParmor/Shield", ShaderDatabase.Transparent);

    public static readonly Material DroneShield =
        MaterialPool.MatFrom("XFMParmor/Shield", ShaderDatabase.Transparent, new Color(1f, 1f, 1f, 0.2f));
